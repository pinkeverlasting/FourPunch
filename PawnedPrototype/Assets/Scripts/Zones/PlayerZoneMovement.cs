...
public class PlayerZoneMovement : MonoBehaviour {
	...
	{
		if (col.gameObject.tag == "Mutant" && col.gameObject.GetComponent<EnemyStatePattern>() != null)
		{
			// Debug.Log("Mutant!");
			//col.gameObject.GetComponent<EnemyStatePattern>().SendMessage("wanderingState.getwayPoint");
		}
	}
